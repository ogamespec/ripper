...
// Игроки ниже указанного TOP не добавляются в БД.
// Решил сделать побольше, т.к. обновление сейчас производится через OGame API и статистика затягивается всё равно целиком.
$MaxPlace = 99999;
