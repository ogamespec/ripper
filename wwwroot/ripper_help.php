...
&copy; ogamespec, 2010, 2012, 2023. Все права на исходный код принадлежат автору.<br><br/>
...
<br/>
Все права на исходную графику и текст, заимствованные из игры OGame принадлежат <a href="http://gameforge.de" target=_blank>GameForge 4D GmbH</a>.<br/>
...
A3. Иконки соответствуют трём уровням доступа: 
<div><span class="ui-icon ui-icon-gear" style="float:left;"></span> - администратор (может также обновлять и просматривать базу), </div>
